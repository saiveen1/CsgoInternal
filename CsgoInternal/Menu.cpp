...
VOID Menu::RenderMenu()
{
	if (menu->settings.showMenu)
	{
		...
		render->DrawText(L"Ctrl+F1 Teammate", menuPos + 16, menu->settings.visual.showTeamates ? menu->color.optionEnable : menu->color.optionDisable);
		render->DrawText(L"Ctrl+F2 SnapLines", menuPos + 32, menu->settings.visual.snaplines ? menu->color.optionEnable : menu->color.optionDisable);
		render->DrawText(L"Ctrl+F3 Box2D", menuPos + 48, menu->settings.visual.rect ? menu->color.optionEnable : menu->color.optionDisable);
		CString strTemp;
		strTemp.Format(L"Ctrl+F4 HealthBar %d", menu->settings.visual.healthBar);
		render->DrawText(strTemp, menuPos + 64, menu->settings.visual.healthBar ? menu->color.optionEnable : menu->color.optionDisable);
		render->DrawText(L"Ctrl+F6 Skeleton", menuPos + 80, menu->settings.visual.skeletonEsp ? menu->color.optionEnable : menu->color.optionDisable);
		render->DrawText(L"Ctrl+F7 NoRecoil", menuPos + 96, menu->settings.noRecoil ? menu->color.optionEnable : menu->color.optionDisable);
		render->DrawText(L"Ctrl+F8 Aimbot", menuPos + 112, menu->settings.aimbot ? menu->color.optionEnable : menu->color.optionDisable);

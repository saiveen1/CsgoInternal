...
VOID Menu::RenderMenu()
{
	if (menu->settings.showMenu)
	{
		...
		render->DrawText(L"-----------------------", menuPos + 128, WHITE);
		render->DrawText(L"Ctrl+0 RecoilCrosshair", menuPos + 144, menu->settings.recoilCrosshair ? menu->color.optionEnable : menu->color.optionDisable);
		...
		render->DrawText(L"ATL + ¡ü¡ýRange¡û¡úSpeed", menuPos + 160, menu->settings.showAimbotRange ? menu->color.optionEnable : menu->color.optionDisable);
